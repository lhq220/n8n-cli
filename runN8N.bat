...
set N8N_PORT=88
::set N8N_EDITOR_BASE_URL=https://n8n.dowasen.com
set WEBHOOK_URL=https://n8n.dowasen.com
set WEBHOOK_TUNNEL_URL=https://n8n.dowasen.com
set N8N_VUE_APP_URL_BASE_API=https://n8n.dowasen.com

set "N8N_BINARY_DATA_STORAGE_PATH=D:\n8n\"

::set N8N_DEFAULT_LOCALE=vi
